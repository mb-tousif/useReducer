      ...
      >
        ...
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <div className='flex justify-between items-center gap-2 '>
            <button onClick={(e) =>dispatch({type: "DECREMENT"})} className='bg-indigo-500 text-lg text-white rounded h-10 w-10 '>
              -
            </button>
            ...
            <button onClick={(e) =>dispatch({type: "INCREMENT"})} className='bg-indigo-500 text-lg text-white rounded h-10 w-10'>
              +
            </button>
          </div>
        </div>
